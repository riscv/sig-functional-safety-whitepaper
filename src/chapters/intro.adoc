...
Functional safety, or dependability, refers to the mechanisms and methods
...
functional safety of the later.
As defined by Avizenis et al. cite:[avizenis:2001] these properties include:
