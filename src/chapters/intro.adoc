...
* Extensive use of documentation, including complete design descriptions,
  -- sometimes only available under non-disclosure agreement (NDA) -- providing
  detailed description of the SoC functional and time behavior required to
  ensure the explainability of the isolation between the different software
...
continuously amended, updated, and extended the identified solutions and
recommendations discussed in this document might be incomplete or outdated.
...
* The *Recommendations* section provides some recommendations on how the current
  and on-going RISC-V specifications can be exploited to address the chapter
  topic.
  These recommendations are both at hardware level, for the design of SoCs
  targeting safety critical systems, and software, for how mechamisms
  implementating those specifications should be used.
