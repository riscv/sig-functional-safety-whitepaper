...
the RISC-V specifications, see previous section, provide an important base to
address the implementation of safety-related hardware performance counters.
Additional activities within RISC-V International _Performance Analysis_ Special
...
* The standarized naming of the different performance events.
* The performance events sampling extensions.
