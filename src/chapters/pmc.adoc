...
ifdef::recommendations-old+recommendations-new[]
WARNING: End of old recommendations, new recommendations hereafter.
endif::[]
ifndef::recommendations-old,recommendations-new[]
WARNING: Recommendations section empty.
endif::[]

ifdef::recommendations-new[]
[#sec:pmc:recom:safety]
#### Safety usage
...
such as authentication of the client(s) that has access to this register.
