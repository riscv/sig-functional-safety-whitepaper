...
| Reliability, Availability and Serviceability.
  Refers to the concept of measuring hardware reliability by counting hardware
  errors which have been corrected, deferred, or have led to component recovery
  action.
...
| Tightly Coupled Memory. Also known as Closely-Coupled Memories (CCMs),
  scratchpad memories, local memories, Tightly Integrated Memories (TIMs), or
  local memories.
